          ...
          <button
            ...
            onClick={async (e) => {
              ...
              try {
                ...
                await new Promise(resolve => setTimeout(resolve, 1000));
                alert('Google sign up initiated! In a real app, this would redirect to Google OAuth.');
              } catch (error) {
          ...
          <button
            ...
            onClick={async (e) => {
              ...
              try {
                ...
                await new Promise(resolve => setTimeout(resolve, 1000));
                alert('GitHub sign up initiated! In a real app, this would redirect to GitHub OAuth.');
              } catch (error) {
